package studio.rockpile.application.framework;
...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        globalConf.setOutputDir("F:/workstation/temporary/mybatis-generator/src");
        globalConf.setSwagger2(true);
        globalConf.setFileOverride(true);
        globalConf.setIdType(IdType.ASSIGN_ID); // 主键生成策略
        globalConf.setServiceName("%sService");
        globalConf.setServiceImplName("%sServiceImpl");
        ...
        strategyConf.setTablePrefix("t_");
        ...
        packageConf.setParent("studio.rockpile.application");
        packageConf.setMapper("server.demo.dao");
        packageConf.setService("server.demo.provider");
        packageConf.setServiceImpl("server.demo.provider.impl");
        packageConf.setController("server.demo.controller");
        packageConf.setEntity("model.entity");
        packageConf.setXml("server.demo.dao.mapper");
